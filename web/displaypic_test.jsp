...
%> 
 ...
 + "</div><div id='usermain'><div id='userpic'>"+
    ...
    <center> 
        <center><img src="images/gol1.jpg" style="margin-top: 0px; z-index: 34;" width="100%"/></center>
...
//	   window.setTimeout("$.colorbox({href:'http://app.yralup.com', width:500, height: 300,open:true});", 3000);
//window.setTimeout(function() {
//    $.colorbox.close();
//}, 15000);
        //For link
   //     $("a.example").colorbox({open:true});
        ...
        //For delay
   //     setTimeout("$(".iframe").colorbox({href:'http://app.yralup.com', width:500, height: 300,open:true});", 3000);
    ...
    (function loop() {
        ...
        var delay = 300000 - (now % 60000); // exact ms to next minute interval
